...
class AutomationRule < ApplicationRecord
  ...
  def conditions_attributes
    %w[content email country_code status message_type browser_language assignee_id assignee_availability team_id referer city
       company_name inbox_id mail_subject phone_number priority conversation_language labels private_note]
  end
